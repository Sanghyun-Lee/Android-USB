================================================================================
    MFC 라이브러리 : TCPClient 프로젝트 개요
================================================================================

응용 프로그램 마법사에서 이 TCPClient 응용 프로그램을 
...
TCPClient.h
    ...
    헤더(Resource.h 포함)가 들어 있고 CTCPClientApp 응용 프로그램
    클래스를 선언합니다.

TCPClient.cpp
    응용 프로그램 클래스 CTCPClientApp이(가) 들어 있는 기본 응용 프로그램
    소스 파일입니다.
...
res\TCPClient.ico
    ...
    주 리소스 파일인 TCPClient.rc에 의해 포함됩니다.
...
TCPClientDlg.h, TCPClientDlg.cpp - 대화 상자
    이 파일에는 CTCPClientDlg 클래스가 들어 있습니다. 이 클래스는
    응용 프로그램의 주 대화 상자 동작을 정의합니다. 대화 상자의 템플릿은
    Microsoft Visual C++에서 편집할 수 있는 TCPClient.rc에 있습니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더 파일(PCH)인 TCPClient.pch와
